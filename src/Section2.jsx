...
export default function Section2() {
    return (
        <>
            <div className='row pt-5 mt-5 section-2 BestPlatform-item'>
                <div className=' col-lg-6 d-flex justify-content-center align-items-center pe-5 section-2-right mb-4 '>
                    <div className='section-2-right pe-5'>
                        <div className=' section-2-dach-position section-2-logo'>
                            <div className=' dach rounded-1 mb-4'></div>
                        </div>
                        <h2 className=' fw-bold mb-4 text-postion'>The best business <br /> solution for you</h2>
                ...
                <div className='col-lg-6 section-2-right row '>
                    <div className=' col-lg-6'>
                        ...
                        <h6 className=' fw-bold mb-3 text-postion'>Scale Your Activity</h6>
                        <div className=' section-2-dach-position section-2-logo'>
                            <div className=' dach-1 rounded-1 mb-3'></div>
                        </div>
                        <p className=' text-secondary text-postion'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe in beatae eligendi blanditiis ad magni! Officia.</p>
                    </div>
                    ...
                    <div className=' col-lg-6'>
                        ...
                        <h6 className=' fw-bold mb-3 text-postion'>Bootcamps</h6>
                        <div className=' section-2-dach-position section-2-logo'>
                            <div className=' dach-1 rounded-1 mb-3'></div>
                        </div>
                        <p className=' text-secondary text-postion'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe in beatae eligendi blanditiis ad magni! Officia.</p>
                    ...
                    <div className=' col-lg-6'>
                        ...
                        <h6 className=' fw-bold mb-3 text-postion'>Hight Quality</h6>
                        <div className=' section-2-dach-position section-2-logo'>
                            <div className=' dach-1 rounded-1 mb-3'></div>
                        </div>
                        <p className=' text-secondary text-postion'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe in beatae eligendi blanditiis ad magni! Officia.</p>
                    ...
                    <div className=' col-lg-6'>
                        ...
                        <h6 className=' fw-bold mb-3 text-postion'>Get Certifcatiob</h6>
                        <div className=' section-2-dach-position section-2-logo'>
                            <div className=' dach-1 rounded-1 mb-3'></div>
                        </div>
                        <p className=' text-secondary text-postion'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe in beatae eligendi blanditiis ad magni! Officia.</p>
